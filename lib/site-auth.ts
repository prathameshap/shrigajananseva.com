...
<style>
  ...
  code { background: #fdf6ea; padding: .15rem .4rem; border-radius: .25rem; font-size: .9em; }
  .mark {
    width: 3rem; height: 3rem; margin: 0 auto 1.25rem; border-radius: 50%;
    background: #751d31; color: #fffcf7; display: grid; place-items: center;
    font: 600 1.25rem/1 Georgia, serif;
  }
  @media (prefers-color-scheme: dark) {
    body { background: #1a120e; color: #ecdcc9; }
